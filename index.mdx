...
import { Figure, Footnotes, Quote, Title } from './mdx-components/index';
...
State management makes the <strong>state of your app</strong> tangible in the form of a <strong>data structure</strong> that you can read from and write to. It makes your ‘invisible’ state clearly visible for you to work with.
</Quote>
