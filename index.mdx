...
- <strong>no direct data mutation</strong>, mutations are described as actions
...
Three principles
- <strong>Single source of truth</strong> (= one store)
- State is <strong>read-only</strong> (= only way to change by emitting actions)
- Changes are made with <strong>pure functions</strong> (pure reducers)
...
<Figure src="https://raw.githubusercontent.com/mobxjs/mobx/master/docs/assets/flow.png" alt="Mobx flow">
    <a href="https://raw.githubusercontent.com/mobxjs/mobx/master/docs/assets/flow.png">https://raw.githubusercontent.com/mobxjs/mobx/master/docs/assets/flow.png</a>
</Figure>
...
<Quote url="https://reactjs.org/docs/hooks-intro.html"><strong>Hooks</strong> are a new addition in React 16.8. They let you use state and other React features without writing a class.</Quote>

<Quote url="https://reactjs.org/docs/context.html"><strong>Context</strong> provides a way to pass data through the component tree without having to pass props down manually at every level.</Quote>

<Footnotes>
    <ul>
        <li><a href="https://dev.to/gloriamaris/implementing-state-management-using-context-api-and-hooks-in-react-36jk">https://dev.to/gloriamaris/implementing-state-management-using-context-api-and-hooks-in-react-36jk</a></li>
        <li><a href="https://github.com/facebookincubator/redux-react-hook">https://github.com/facebookincubator/redux-react-hook</a></li>
    </ul>
</Footnotes>
...
- out of the box state management included
- basically not usable without state and actions
...
- subscriptions to stores `subscribe`
- mutations via `update` or `set`
...
Strongly depends on the use case and framework (React, Vue, Angular,...) being used. If none of them is already in use consider using a lightweight batteries included library like Svelte or Hyperapp.
